---
title: Markdown 编辑器
description: 功能强大的 Markdown 编辑器，支持多种编辑模式、AI 辅助写作和实时同步功能。
icon: PenTool
---
...
<Cards>
  <Card icon={<MessageCircleQuestion />} title="问答">
    类似于 AI 对话，可以输入问题，AI 会返回答案。
  </Card>
  <Card icon={<ListPlus />} title="续写">
    根据你的上文，AI 会继续写下去，帮助你在无灵感时继续写作。
  </Card>
  <Card icon={<Lollipop />} title="优化">
    选中一段文字，AI 会润色这段文字。
  </Card>
  <Card icon={<Languages />} title="翻译">
    选中一段文字，AI 会翻译这段文字。
  </Card>
</Cards>
