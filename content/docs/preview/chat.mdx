---
title: AI 助手
description: AI 助手是记录中的一个重要组成部分，通过对话的形式增强记录的效率。
icon: Bot
---
...
<Cards>
  ...
  <Card icon={<BotMessageSquare />} title="AI 模型">
    AI 模型，包括模型名称和厂商名称，仅作展示。
  </Card>
  <Card icon={<MessageSquarePlus />} title="使用新标签开始对话">
    点击后弹出对话框，输入新标签名，进行一段新的对话，同时会创建一个新的标签。
  </Card>
  <Card icon={<Trash2 />} title="删除对话">
