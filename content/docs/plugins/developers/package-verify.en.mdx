...
- an existing UTF-8 `.js` file at the manifest's `entry` path;
...
- `.env` and `.env.*`;
- native libraries, executables, installers, shell scripts, Java class or JAR files, WASM, source maps, and sensitive PEM/P12/PFX files;
