...
<Image width="0" height="0" src="https://s2.loli.net/2025/07/10/twNG14nsJZvPW6r.png" />

## Create Model Configuration

Click the `Create New Configuration` button to open custom and mainstream model provider templates for selection:

<Image width="0" height="0" src="https://s2.loli.net/2025/07/10/2J9jTLGeSO5HPhw.png" />
