...
<Image width={600} height={400} src="https://s2.loli.net/2025/07/10/twNG14nsJZvPW6r.png" alt="Model configuration interface showing provider templates" />

## Create Model Configuration

Click the `Create New Configuration` button to open custom and mainstream model provider templates for selection:

<Image width={600} height={400} src="https://s2.loli.net/2025/07/10/2J9jTLGeSO5HPhw.png" alt="Create new configuration dialog showing model providers" />
...
Currently supported: Conversation, Speech, Embedding, Reranking.

- Conversation: The most commonly used model type for conversations, writing, and other scenarios.
- Speech: Used for speech recognition (STT) and text-to-speech (TTS) features, configurable in audio settings.
