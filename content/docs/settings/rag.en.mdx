...
<Image width={600} height={400} src="https://s2.loli.net/2025/07/10/57gNKq8CPa6kZ1V.png" alt="Knowledge base configuration interface showing model settings" />
...
<Image width={600} height={400} src="https://s2.loli.net/2025/07/10/DgjJU7rNypiH1kb.png" alt="Knowledge base enable dialog in record page" />
...
<Image width={600} height={400} src="https://s2.loli.net/2025/07/10/TErOmSFLPqo1Xtb.png" alt="Full vector computation dialog for existing files" />
