...
<img src="https://files.seeusercontent.com/2026/07/16/Cy5j/desktop-image-hosting-settings.jpeg" alt="Desktop Image Hosting settings" className="rounded-xl border" />
...
- [Create a GitHub fine-grained personal access token](https://github.com/settings/personal-access-tokens/new?name=NoteGen&description=NoteGen+image+hosting&expires_in=none&contents=write&administration=write): prefills no expiration, Contents, and Administration.
